...
<h2>회원가입</h2>
  ...
  placeholder="이름" style="margin-top: 20px;" required="required">
  <input type="text" class="form-control" name="mem_id" id="id"
  onkeyup = "checkId()"
  placeholder="아이디" style="margin-top: 20px;" required="required" maxlength="8">
  <b class="idmsg"></b>
  <input type="email" class="form-control" name="mem_email" id="mail" onkeyup="checkEmail()"
  placeholder="이메일" style="margin-top: 20px;" required="required">
  <b><div id="error_mail" class="result-email result-check"></div></b>
  <input type="text" class="form-control" name="mem_hp"
  placeholder="핸드폰번호" style="margin-top: 20px;" required="required">
  ...
  <button type="submit" class="btn btn-info" style="margin-top: 30px; width: 600px;">회원가입</button>
</form>
